...
export declare class ImmutableXClient {
    ...
    createOrderRequestV3F({ user, tokenSell, tokenBuy, amountSell, amountBuy, fees, splitFees, expiration_timestamp, }: ImmutableMethodParams.ImmutableGetSignableOrderParams): TE.TaskEither<Error, {
        signableOrderResult: ImmutableMethodResults.ImmutableGetSignableOrderResult;
    ...
    createOrderV3F({ user, tokenSell, tokenBuy, amountSell, amountBuy, fees, splitFees, expiration_timestamp, }: ImmutableMethodParams.ImmutableGetSignableOrderParams): TE.TaskEither<Error, ImmutableMethodResults.ImmutableCreateOrderResult>;
    ...
    getOrderV3F({ orderId, include_fees, auxiliaryFees, }: ImmutableMethodParams.ImmutableGetOrderParams): TE.TaskEither<Error, ImmutableMethodResults.ImmutableGetOrderV3Result>;
    getOrderV3(params: ImmutableMethodParams.ImmutableGetOrderParamsTS): Promise<ImmutableMethodResults.ImmutableGetOrderV3Result>;
    ...
    getOrdersV3F(query: ImmutableMethodParams.ImmutableGetOrdersParams): TE.TaskEither<Error, ImmutableMethodResults.ImmutableGetOrdersV3Result>;
    getOrdersV3(params?: ImmutableMethodParams.ImmutableGetOrdersParamsTS): Promise<ImmutableMethodResults.ImmutableGetOrdersV3Result>;
    ...
    getTradeV3F({ id, }: ImmutableMethodParams.ImmutableGetTradeParams): TE.TaskEither<Error, ImmutableMethodResults.ImmutableTrade>;
    getTradeV3(params: ImmutableMethodParams.ImmutableGetTradeParamsTS): Promise<ImmutableMethodResults.ImmutableTrade>;
    ...
    getTradesV3F(query?: ImmutableMethodParams.ImmutableGetTradesParams): TE.TaskEither<Error, ImmutableMethodResults.ImmutableGetTradesResult>;
    getTradesV3(params?: ImmutableMethodParams.ImmutableGetTradesParamsTS): Promise<ImmutableMethodResults.ImmutableGetTradesResult>;
