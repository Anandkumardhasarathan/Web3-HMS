...
export declare class ImmutableXController {
    ...
    createOrderWithFeeV3(starkPublicKey: string, sell_vault_id: t.Int, buy_vault_id: t.Int, sell_amount: BigNumber, buy_amount: BigNumber, sell_id: string, buy_id: string, nonce: t.Int, expirationTimestamp: t.Int, fee_info: FeeParams): TE.TaskEither<Error, string>;
