...
export declare function checkIfHashedKeyIsAboveLimit(privateKey: string): boolean;
...
export declare function getKeyPairFromPath(seed: string, path: string, ethAddress: string): Promise<ec.KeyPair>;
