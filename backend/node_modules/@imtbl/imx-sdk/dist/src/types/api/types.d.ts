...
export declare enum ImmutableOrderMakerTakerType {
    maker = "maker",
    taker = "taker"
}
...
export declare const ImmutableOrderMakerTakerTypeCodec: t.Type<ImmutableOrderMakerTakerType, ImmutableOrderMakerTakerType, unknown>;
...
export declare namespace ImmutableMethodResults {
    ...
    const ImmutableOrderMakerTakerFeesTypeCodec: t.IntersectionC<[t.TypeC<{
        quantity_with_fees: t.BrandC<t.Type<import("ethers").BigNumber, import("ethers").BigNumber, unknown>, import("../runtime").PositiveBigNumberBrand>;
        token_type: t.UnionC<[t.Type<import("../runtime").ERC721TokenType, import("../runtime").ERC721TokenType, unknown>, t.Type<import("../runtime").ERC20TokenType, import("../runtime").ERC20TokenType, unknown>, t.Type<import("../runtime").ETHTokenType, import("../runtime").ETHTokenType, unknown>, t.Type<import("../runtime").MintableERC20TokenType, import("../runtime").MintableERC20TokenType, unknown>, t.Type<import("../runtime").MintableERC721TokenType, import("../runtime").MintableERC721TokenType, unknown>]>;
        decimals: t.BrandC<t.NumberC, t.IntBrand>;
        symbol: t.StringC;
    }>, t.PartialC<{
        token_address: t.StringC;
        fees: t.UnionC<[t.ArrayC<t.TypeC<{
            type: t.Type<ImmutableFeeType, ImmutableFeeType, unknown>;
            address: t.StringC;
            token: t.TypeC<{
    ...
    type ImmutableOrderMakerTakerFeesType = t.TypeOf<typeof ImmutableOrderMakerTakerFeesTypeCodec>;
    type ImmutableOrderMakerTakerFeesTypeTS = t.OutputOf<typeof ImmutableOrderMakerTakerFeesTypeCodec>;
    const ImmutableGetOrderV3ResultCodec: t.IntersectionC<[t.TypeC<{
        order_id: t.BrandC<t.NumberC, t.IntBrand>;
        status: t.Type<ImmutableOrderStatus, ImmutableOrderStatus, unknown>;
        user: t.BrandC<t.StringC, import("../runtime").EthAddressBrand>;
        sell: t.UnionC<[t.TypeC<{
        ...
        expiration_timestamp: import("io-ts-types").DateFromISOStringC;
        timestamp: import("io-ts-types").DateFromISOStringC;
        updated_timestamp: import("io-ts-types").DateFromISOStringC;
        maker_taker_type: t.Type<ImmutableOrderMakerTakerType, ImmutableOrderMakerTakerType, unknown>;
        maker_fees: t.IntersectionC<[t.TypeC<{
            quantity_with_fees: t.BrandC<t.Type<import("ethers").BigNumber, import("ethers").BigNumber, unknown>, import("../runtime").PositiveBigNumberBrand>;
            token_type: t.UnionC<[t.Type<import("../runtime").ERC721TokenType, import("../runtime").ERC721TokenType, unknown>, t.Type<import("../runtime").ERC20TokenType, import("../runtime").ERC20TokenType, unknown>, t.Type<import("../runtime").ETHTokenType, import("../runtime").ETHTokenType, unknown>, t.Type<import("../runtime").MintableERC20TokenType, import("../runtime").MintableERC20TokenType, unknown>, t.Type<import("../runtime").MintableERC721TokenType, import("../runtime").MintableERC721TokenType, unknown>]>;
            decimals: t.BrandC<t.NumberC, t.IntBrand>;
            symbol: t.StringC;
        ...
        taker_fees: t.IntersectionC<[t.TypeC<{
            quantity_with_fees: t.BrandC<t.Type<import("ethers").BigNumber, import("ethers").BigNumber, unknown>, import("../runtime").PositiveBigNumberBrand>;
            token_type: t.UnionC<[t.Type<import("../runtime").ERC721TokenType, import("../runtime").ERC721TokenType, unknown>, t.Type<import("../runtime").ERC20TokenType, import("../runtime").ERC20TokenType, unknown>, t.Type<import("../runtime").ETHTokenType, import("../runtime").ETHTokenType, unknown>, t.Type<import("../runtime").MintableERC20TokenType, import("../runtime").MintableERC20TokenType, unknown>, t.Type<import("../runtime").MintableERC721TokenType, import("../runtime").MintableERC721TokenType, unknown>]>;
            decimals: t.BrandC<t.NumberC, t.IntBrand>;
            symbol: t.StringC;
    ...
    type ImmutableGetOrderV3Result = t.TypeOf<typeof ImmutableGetOrderV3ResultCodec>;
    type ImmutableGetOrderV3ResultTS = t.OutputOf<typeof ImmutableGetOrderV3ResultCodec>;
    const ImmutableGetOrdersV3ResultCodec: t.IntersectionC<[t.TypeC<{
        result: t.ArrayC<t.IntersectionC<[t.TypeC<{
            order_id: t.BrandC<t.NumberC, t.IntBrand>;
            status: t.Type<ImmutableOrderStatus, ImmutableOrderStatus, unknown>;
            user: t.BrandC<t.StringC, import("../runtime").EthAddressBrand>;
    ...
    type ImmutableGetOrdersV3Result = t.TypeOf<typeof ImmutableGetOrdersV3ResultCodec>;
