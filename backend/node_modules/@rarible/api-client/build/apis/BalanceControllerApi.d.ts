...
import { Balance, UnionApiErrorBadRequest, UnionApiErrorEntityNotFound, UnionApiErrorServerError } from '../models';
 ...
 * no description
 */
export declare class BalanceControllerApi extends runtime.BaseAPI {
    /**
     * Return user\'s balance of specified currency
     * Get balance
     */
    getBalanceRaw(requestParameters: GetBalanceRequest): Promise<GetBalanceResponse>;
    /**
     * Return user\'s balance of specified currency
     * Get balance
     */
...
export type GetBalance404 = {
    status: 404;
    value: UnionApiErrorEntityNotFound;
};
export type GetBalance400 = {
    status: 400;
    value: UnionApiErrorBadRequest;
};
export type GetBalance500 = {
    status: 500;
    value: UnionApiErrorServerError;
};
export type GetBalanceResponse = GetBalance200 | GetBalance404 | GetBalance400 | GetBalance500;
