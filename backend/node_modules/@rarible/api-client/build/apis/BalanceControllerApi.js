...
var BalanceControllerApi = /** @class */ (function (_super) {
     ...
     * Get balance
     */
    BalanceControllerApi.prototype.getBalanceRaw = function (requestParameters) {
                ...
                switch (_e.label) {
                    case 0:
                        if (requestParameters.currencyId === null || requestParameters.currencyId === undefined) {
                            throw new runtime.RequiredError('currencyId', 'Required parameter requestParameters.currencyId was null or undefined when calling getBalance.');
                        }
                        if (requestParameters.owner === null || requestParameters.owner === undefined) {
                            throw new runtime.RequiredError('owner', 'Required parameter requestParameters.owner was null or undefined when calling getBalance.');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        ...
                        return [4 /*yield*/, this.request({
                                path: "/v0.1/balances/{currencyId}/{owner}".replace("{".concat("currencyId", "}"), encodeURIComponent(String(requestParameters.currencyId))).replace("{".concat("owner", "}"), encodeURIComponent(String(requestParameters.owner))),
                                method: 'GET',
     ...
     * Get balance
     */
    BalanceControllerApi.prototype.getBalance = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getBalanceRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
