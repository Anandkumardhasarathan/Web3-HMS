...
import { Blockchain, LatestIndexedBlock, UnionApiErrorBadRequest, UnionApiErrorEntityNotFound, UnionApiErrorServerError } from '../models';
export interface GetLatestIndexedBlockRequest {
    blockchain: Blockchain;
}
/**
 * no description
 */
export declare class BlockControllerApi extends runtime.BaseAPI {
    /**
     * Get latest indexed block for blockchain
     * Get latest indexed block
     */
    getLatestIndexedBlockRaw(requestParameters: GetLatestIndexedBlockRequest): Promise<GetLatestIndexedBlockResponse>;
    /**
     * Get latest indexed block for blockchain
     * Get latest indexed block
     */
    getLatestIndexedBlock(requestParameters: GetLatestIndexedBlockRequest): Promise<LatestIndexedBlock>;
}
export type GetLatestIndexedBlock200 = {
    status: 200;
    value: LatestIndexedBlock;
};
export type GetLatestIndexedBlock400 = {
    status: 400;
    value: UnionApiErrorBadRequest;
};
export type GetLatestIndexedBlock404 = {
    status: 404;
    value: UnionApiErrorEntityNotFound;
};
export type GetLatestIndexedBlock500 = {
    status: 500;
    value: UnionApiErrorServerError;
};
export type GetLatestIndexedBlockResponse = GetLatestIndexedBlock200 | GetLatestIndexedBlock400 | GetLatestIndexedBlock404 | GetLatestIndexedBlock500;
