...
exports.BlockControllerApi = void 0;
var runtime = __importStar(require("../runtime"));
/**
 * no description
 */
var BlockControllerApi = /** @class */ (function (_super) {
    __extends(BlockControllerApi, _super);
    function BlockControllerApi() {
     ...
     */
    BlockControllerApi.prototype.getLatestIndexedBlockRaw = function (requestParameters) {
                ...
                switch (_e.label) {
                    case 0:
                        if (requestParameters.blockchain === null || requestParameters.blockchain === undefined) {
                            throw new runtime.RequiredError('blockchain', 'Required parameter requestParameters.blockchain was null or undefined when calling getLatestIndexedBlock.');
                        }
                        queryParameters = {};
     ...
     * Get latest indexed block
     */
    BlockControllerApi.prototype.getLatestIndexedBlock = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getLatestIndexedBlockRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
    ...
    return BlockControllerApi;
}(runtime.BaseAPI));
exports.BlockControllerApi = BlockControllerApi;
