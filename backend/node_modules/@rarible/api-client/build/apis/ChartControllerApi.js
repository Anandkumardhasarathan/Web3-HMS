...
exports.ChartControllerApi = void 0;
var runtime = __importStar(require("../runtime"));
/**
 * no description
 */
var ChartControllerApi = /** @class */ (function (_super) {
    __extends(ChartControllerApi, _super);
    function ChartControllerApi() {
     ...
     */
    ChartControllerApi.prototype.getFloorPriceChartRaw = function (requestParameters) {
                ...
                switch (_e.label) {
                    case 0:
                        if (requestParameters.id === null || requestParameters.id === undefined) {
                            throw new runtime.RequiredError('id', 'Required parameter requestParameters.id was null or undefined when calling getFloorPriceChart.');
                        }
                        if (requestParameters.period === null || requestParameters.period === undefined) {
                            throw new runtime.RequiredError('period', 'Required parameter requestParameters.period was null or undefined when calling getFloorPriceChart.');
                        }
                        if (requestParameters.size === null || requestParameters.size === undefined) {
                            throw new runtime.RequiredError('size', 'Required parameter requestParameters.size was null or undefined when calling getFloorPriceChart.');
                        }
                        queryParameters = {};
                        ...
                        return [4 /*yield*/, this.request({
                                path: "/v2.0/data/collections/{id}/charts/floorPrice".replace("{".concat("id", "}"), encodeURIComponent(String(requestParameters.id))),
                                method: 'GET',
     ...
     * Get historical data of floor price for collection for charting purposes
     */
    ChartControllerApi.prototype.getFloorPriceChart = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getFloorPriceChartRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
