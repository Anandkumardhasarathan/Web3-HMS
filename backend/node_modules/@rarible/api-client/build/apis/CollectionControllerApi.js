...
var CollectionControllerApi = /** @class */ (function (_super) {
     ...
     * Generate TokenId
     */
    CollectionControllerApi.prototype.generateTokenIdRaw = function (requestParameters) {
                ...
                switch (_d.label) {
                    case 0:
                        if (requestParameters.collection === null || requestParameters.collection === undefined) {
                            throw new runtime.RequiredError('collection', 'Required parameter requestParameters.collection was null or undefined when calling generateTokenId.');
                        }
                        if (requestParameters.minter === null || requestParameters.minter === undefined) {
                            throw new runtime.RequiredError('minter', 'Required parameter requestParameters.minter was null or undefined when calling generateTokenId.');
                        }
                        queryParameters = {};
                        ...
                        return [4 /*yield*/, this.request({
                                path: "/v0.1/collections/{collection}/generateTokenId".replace("{".concat("collection", "}"), encodeURIComponent(String(requestParameters.collection))),
                                method: 'GET',
     ...
     * Generate TokenId
     */
    CollectionControllerApi.prototype.generateTokenId = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.generateTokenIdRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                path: "/v0.1/collections/{collection}".replace("{".concat("collection", "}"), encodeURIComponent(String(requestParameters.collection))),
                                method: 'GET',
                                headers: headerParameters,
                                query: queryParameters,
                            })];
     ...
     * Reset NFT metadata
     */
    CollectionControllerApi.prototype.refreshCollectionItemsMetaRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (requestParameters.collection === null || requestParameters.collection === undefined) {
                            throw new runtime.RequiredError('collection', 'Required parameter requestParameters.collection was null or undefined when calling refreshCollectionItemsMeta.');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        if (this.configuration && this.configuration.apiKey) {
                        ...
                        return [4 /*yield*/, this.request({
                                path: "/v0.1/collections/{collection}/refreshMeta".replace("{".concat("collection", "}"), encodeURIComponent(String(requestParameters.collection))),
                                method: 'DELETE',
                                headers: headerParameters,
                                query: queryParameters,
                            })];
     ...
     * Reset NFT metadata
     */
    CollectionControllerApi.prototype.refreshCollectionItemsMeta = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.refreshCollectionItemsMetaRaw(requestParameters)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
     ...
     */
    CollectionControllerApi.prototype.resetCollectionMetaRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (requestParameters.collection === null || requestParameters.collection === undefined) {
                            throw new runtime.RequiredError('collection', 'Required parameter requestParameters.collection was null or undefined when calling resetCollectionMeta.');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        if (this.configuration && this.configuration.apiKey) {
                        ...
                        return [4 /*yield*/, this.request({
                                path: "/v0.1/collections/{collection}/resetMeta".replace("{".concat("collection", "}"), encodeURIComponent(String(requestParameters.collection))),
                                method: 'DELETE',
                                headers: headerParameters,
                                query: queryParameters,
                            })];
     ...
     * Reset Collection metadata
     */
    CollectionControllerApi.prototype.resetCollectionMeta = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.resetCollectionMetaRaw(requestParameters)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
