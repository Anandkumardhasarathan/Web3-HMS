...
export interface GetCollectionLeaderboardRequest {
    ...
    direction?: OlapLeaderboardSortDirection;
    limit?: number;
    offset?: number;
}
export interface GetCollectionLeaderboardByOwnerRequest {
    owners: Array<string>;
    blockchains?: Array<OlapBlockchain>;
    period?: OlapPeriod;
    sort?: OlapLeaderboardSort;
 ...
 * no description
 */
export declare class CollectionLeaderboardControllerApi extends runtime.BaseAPI {
    /**
     * Collections leaderboard
     * Get NFT Collections leaderboard
     */
    getCollectionLeaderboardRaw(requestParameters: GetCollectionLeaderboardRequest): Promise<GetCollectionLeaderboardResponse>;
    /**
     * Collections leaderboard
     * Get NFT Collections leaderboard
     */
    getCollectionLeaderboard(requestParameters: GetCollectionLeaderboardRequest): Promise<OlapCollectionLeaderboardResponse>;
    /**
     * User collections leaderboard
     * Get NFT Collections leaderboard for a specific owner adresses
     */
    getCollectionLeaderboardByOwnerRaw(requestParameters: GetCollectionLeaderboardByOwnerRequest): Promise<GetCollectionLeaderboardByOwnerResponse>;
    /**
     * User collections leaderboard
     * Get NFT Collections leaderboard for a specific owner adresses
     */
    getCollectionLeaderboardByOwner(requestParameters: GetCollectionLeaderboardByOwnerRequest): Promise<OlapCollectionLeaderboardResponse>;
}
export type GetCollectionLeaderboard200 = {
    status: 200;
    value: OlapCollectionLeaderboardResponse;
};
export type GetCollectionLeaderboard400 = {
    status: 400;
    value: OlapError;
};
export type GetCollectionLeaderboard500 = {
    status: 500;
    value: OlapError;
};
export type GetCollectionLeaderboardResponse = GetCollectionLeaderboard200 | GetCollectionLeaderboard400 | GetCollectionLeaderboard500;
export type GetCollectionLeaderboardByOwner200 = {
    status: 200;
    value: OlapCollectionLeaderboardResponse;
};
export type GetCollectionLeaderboardByOwner400 = {
    status: 400;
    value: OlapError;
};
export type GetCollectionLeaderboardByOwner500 = {
    status: 500;
    value: OlapError;
};
export type GetCollectionLeaderboardByOwnerResponse = GetCollectionLeaderboardByOwner200 | GetCollectionLeaderboardByOwner400 | GetCollectionLeaderboardByOwner500;
