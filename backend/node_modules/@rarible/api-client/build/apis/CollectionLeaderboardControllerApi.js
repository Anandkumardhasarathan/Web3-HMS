...
exports.CollectionLeaderboardControllerApi = void 0;
var runtime = __importStar(require("../runtime"));
/**
 * no description
 */
var CollectionLeaderboardControllerApi = /** @class */ (function (_super) {
    __extends(CollectionLeaderboardControllerApi, _super);
    function CollectionLeaderboardControllerApi() {
     ...
     */
    CollectionLeaderboardControllerApi.prototype.getCollectionLeaderboardRaw = function (requestParameters) {
     ...
     * Get NFT Collections leaderboard
     */
    CollectionLeaderboardControllerApi.prototype.getCollectionLeaderboard = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getCollectionLeaderboardRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
     ...
     */
    CollectionLeaderboardControllerApi.prototype.getCollectionLeaderboardByOwnerRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            var _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        if (requestParameters.owners === null || requestParameters.owners === undefined) {
                            throw new runtime.RequiredError('owners', 'Required parameter requestParameters.owners was null or undefined when calling getCollectionLeaderboardByOwner.');
                        }
                        queryParameters = {};
     ...
     * Get NFT Collections leaderboard for a specific owner adresses
     */
    CollectionLeaderboardControllerApi.prototype.getCollectionLeaderboardByOwner = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getCollectionLeaderboardByOwnerRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
                        if (response.status === 200) {
                            return [2 /*return*/, response.value];
    ...
    return CollectionLeaderboardControllerApi;
}(runtime.BaseAPI));
exports.CollectionLeaderboardControllerApi = CollectionLeaderboardControllerApi;
