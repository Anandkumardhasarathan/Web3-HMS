...
import { Currencies, CurrencyUsdRate, UnionApiErrorBadRequest, UnionApiErrorServerError } from '../models';
export interface GetUsdRateRequest {
    currencyId: string;
    at: Date;
}
/**
...
export declare class CurrencyControllerApi extends runtime.BaseAPI {
     ...
     */
    getAllCurrenciesRaw(): Promise<GetAllCurrenciesResponse>;
    /**
     * List of currencies, supported by Protocol
     * Get supported currencies
     */
     ...
     * Get USD rate
     */
    getUsdRateRaw(requestParameters: GetUsdRateRequest): Promise<GetUsdRateResponse>;
    /**
     * Get currency USD rate by currency blockchain\'s address
     * Get USD rate
     */
    getUsdRate(requestParameters: GetUsdRateRequest): Promise<CurrencyUsdRate>;
}
...
export type GetUsdRate200 = {
    status: 200;
    value: CurrencyUsdRate;
};
export type GetUsdRate400 = {
    status: 400;
    value: UnionApiErrorBadRequest;
};
export type GetUsdRate500 = {
    status: 500;
    value: UnionApiErrorServerError;
};
export type GetUsdRateResponse = GetUsdRate200 | GetUsdRate400 | GetUsdRate500;
