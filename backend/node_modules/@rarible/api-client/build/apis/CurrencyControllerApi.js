...
var CurrencyControllerApi = /** @class */ (function (_super) {
     ...
     * Get USD rate
     */
    CurrencyControllerApi.prototype.getUsdRateRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            var _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        if (requestParameters.currencyId === null || requestParameters.currencyId === undefined) {
                            throw new runtime.RequiredError('currencyId', 'Required parameter requestParameters.currencyId was null or undefined when calling getUsdRate.');
                        }
                        if (requestParameters.at === null || requestParameters.at === undefined) {
                            throw new runtime.RequiredError('at', 'Required parameter requestParameters.at was null or undefined when calling getUsdRate.');
                        }
                        queryParameters = {};
                        ...
                        return [4 /*yield*/, this.request({
                                path: "/v0.1/currencies/{currencyId}/rates/usd".replace("{".concat("currencyId", "}"), encodeURIComponent(String(requestParameters.currencyId))),
                                method: 'GET',
                                headers: headerParameters,
                                query: queryParameters,
                            })];
     ...
     * Get USD rate
     */
    CurrencyControllerApi.prototype.getUsdRate = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getUsdRateRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
                        if (response.status === 200) {
                            return [2 /*return*/, response.value];
