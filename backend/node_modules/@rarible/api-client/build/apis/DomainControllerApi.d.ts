...
import { DomainResolveResult, UnionApiErrorBadRequest, UnionApiErrorEntityNotFound, UnionApiErrorServerError } from '../models';
...
export declare class DomainControllerApi extends runtime.BaseAPI {
     ...
     * Resolve domain
     */
    resolveRaw(requestParameters: ResolveRequest): Promise<ResolveResponse>;
    /**
     * Resolves domain\'s blockchain address by its name (for example, from ENS domains collection)
     * Resolve domain
     */
    resolve(requestParameters: ResolveRequest): Promise<DomainResolveResult>;
}
export type Resolve200 = {
    status: 200;
    value: DomainResolveResult;
};
export type Resolve400 = {
    status: 400;
    value: UnionApiErrorBadRequest;
};
export type Resolve404 = {
    status: 404;
    value: UnionApiErrorEntityNotFound;
};
export type Resolve500 = {
    status: 500;
    value: UnionApiErrorServerError;
};
export type ResolveResponse = Resolve200 | Resolve400 | Resolve404 | Resolve500;
