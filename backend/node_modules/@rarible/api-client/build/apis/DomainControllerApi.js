...
var DomainControllerApi = /** @class */ (function (_super) {
     ...
     * Resolve domain
     */
    DomainControllerApi.prototype.resolveRaw = function (requestParameters) {
                ...
                switch (_e.label) {
                    case 0:
                        if (requestParameters.domain === null || requestParameters.domain === undefined) {
                            throw new runtime.RequiredError('domain', 'Required parameter requestParameters.domain was null or undefined when calling resolve.');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        ...
                        return [4 /*yield*/, this.request({
                                path: "/v0.1/domains/{domain}/resolution".replace("{".concat("domain", "}"), encodeURIComponent(String(requestParameters.domain))),
                                method: 'POST',
     ...
     * Resolve domain
     */
    DomainControllerApi.prototype.resolve = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.resolveRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
