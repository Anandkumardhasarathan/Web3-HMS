...
exports.EncodeControllerApi = void 0;
var runtime = __importStar(require("../runtime"));
/**
 * no description
 */
var EncodeControllerApi = /** @class */ (function (_super) {
    __extends(EncodeControllerApi, _super);
    function EncodeControllerApi() {
     ...
     * Generate order encode data for sign operations
     */
    EncodeControllerApi.prototype.encodeRaw = function (requestParameters) {
                ...
                switch (_d.label) {
                    case 0:
                        if (requestParameters.orderForm === null || requestParameters.orderForm === undefined) {
                            throw new runtime.RequiredError('orderForm', 'Required parameter requestParameters.orderForm was null or undefined when calling encode.');
                        }
                        queryParameters = {};
                        headerParameters = {};
     ...
     * Generate order encode data for sign operations
     */
    EncodeControllerApi.prototype.encode = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.encodeRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
    ...
    return EncodeControllerApi;
}(runtime.BaseAPI));
exports.EncodeControllerApi = EncodeControllerApi;
