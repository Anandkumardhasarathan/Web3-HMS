...
import { Blockchain, ReconciliationEntities, UnionApiErrorBadRequest, UnionApiErrorServerError } from '../models';
 ...
 * no description
 */
export declare class ReconciliationControllerApi extends runtime.BaseAPI {
    /**
     * Return short view of items updated after a specific datetime.
     * Get IDs of items updated after a specific datetime.
     */
    getReconciliationItemsRaw(requestParameters: GetReconciliationItemsRequest): Promise<GetReconciliationItemsResponse>;
    /**
     * Return short view of items updated after a specific datetime.
     * Get IDs of items updated after a specific datetime.
     */
    getReconciliationItems(requestParameters: GetReconciliationItemsRequest): Promise<ReconciliationEntities>;
}
export type GetReconciliationItems200 = {
    status: 200;
    value: ReconciliationEntities;
};
export type GetReconciliationItems400 = {
    status: 400;
    value: UnionApiErrorBadRequest;
};
export type GetReconciliationItems500 = {
    status: 500;
    value: UnionApiErrorServerError;
};
export type GetReconciliationItemsResponse = GetReconciliationItems200 | GetReconciliationItems400 | GetReconciliationItems500;
