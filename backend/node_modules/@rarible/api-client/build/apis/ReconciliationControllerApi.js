...
exports.ReconciliationControllerApi = void 0;
var runtime = __importStar(require("../runtime"));
/**
 * no description
 */
var ReconciliationControllerApi = /** @class */ (function (_super) {
    __extends(ReconciliationControllerApi, _super);
    function ReconciliationControllerApi() {
     ...
     */
    ReconciliationControllerApi.prototype.getReconciliationItemsRaw = function (requestParameters) {
                ...
                switch (_d.label) {
                    case 0:
                        if (requestParameters.blockchain === null || requestParameters.blockchain === undefined) {
                            throw new runtime.RequiredError('blockchain', 'Required parameter requestParameters.blockchain was null or undefined when calling getReconciliationItems.');
                        }
                        if (requestParameters.updatedAfterInclusive === null || requestParameters.updatedAfterInclusive === undefined) {
                            throw new runtime.RequiredError('updatedAfterInclusive', 'Required parameter requestParameters.updatedAfterInclusive was null or undefined when calling getReconciliationItems.');
                        }
                        if (requestParameters.updatedBeforeExclusive === null || requestParameters.updatedBeforeExclusive === undefined) {
                            throw new runtime.RequiredError('updatedBeforeExclusive', 'Required parameter requestParameters.updatedBeforeExclusive was null or undefined when calling getReconciliationItems.');
                        }
                        queryParameters = {};
                        if (requestParameters.blockchain !== undefined) {
                            queryParameters['blockchain'] = requestParameters.blockchain;
                        }
                        if (requestParameters.updatedAfterInclusive !== undefined) {
                            queryParameters['updatedAfterInclusive'] = requestParameters.updatedAfterInclusive.toISOString();
                        }
                        if (requestParameters.updatedBeforeExclusive !== undefined) {
                            queryParameters['updatedBeforeExclusive'] = requestParameters.updatedBeforeExclusive.toISOString();
                        }
     ...
     * Get IDs of items updated after a specific datetime.
     */
    ReconciliationControllerApi.prototype.getReconciliationItems = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getReconciliationItemsRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
    ...
    return ReconciliationControllerApi;
}(runtime.BaseAPI));
exports.ReconciliationControllerApi = ReconciliationControllerApi;
