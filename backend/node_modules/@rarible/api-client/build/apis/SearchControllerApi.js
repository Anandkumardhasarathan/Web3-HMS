...
exports.SearchControllerApi = void 0;
var runtime = __importStar(require("../runtime"));
/**
 * no description
 */
var SearchControllerApi = /** @class */ (function (_super) {
    __extends(SearchControllerApi, _super);
    function SearchControllerApi() {
     ...
     * Search Activities
     */
    SearchControllerApi.prototype.searchActivitiesRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        if (requestParameters.activitySearchRequest === null || requestParameters.activitySearchRequest === undefined) {
                            throw new runtime.RequiredError('activitySearchRequest', 'Required parameter requestParameters.activitySearchRequest was null or undefined when calling searchActivities.');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        ...
                        return [4 /*yield*/, this.request({
                                ...
                                body: requestParameters.activitySearchRequest,
                            })];
                    case 1:
                        response = _d.sent();
     ...
     * Search Activities
     */
    SearchControllerApi.prototype.searchActivities = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.searchActivitiesRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
     ...
     */
    SearchControllerApi.prototype.searchCollectionRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            var _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        if (requestParameters.collectionsSearchRequest === null || requestParameters.collectionsSearchRequest === undefined) {
                            throw new runtime.RequiredError('collectionsSearchRequest', 'Required parameter requestParameters.collectionsSearchRequest was null or undefined when calling searchCollection.');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        headerParameters['Content-Type'] = 'application/json';
                        ...
                        return [4 /*yield*/, this.request({
                                ...
                                headers: headerParameters,
                                query: queryParameters,
                                body: requestParameters.collectionsSearchRequest,
                            })];
                    case 1:
                        response = _d.sent();
                        if (!(response.status === 200)) return [3 /*break*/, 3];
     ...
     * Search NFT Collections
     */
    SearchControllerApi.prototype.searchCollection = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.searchCollectionRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
                        if (response.status === 200) {
                            return [2 /*return*/, response.value];
     ...
     * Search NFTs
     */
    SearchControllerApi.prototype.searchItemsRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            var _a, _b, _c;
            return __generator(this, function (_d) {
     ...
     * Search NFTs
     */
    SearchControllerApi.prototype.searchItems = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    SearchControllerApi.prototype.searchOwnershipsRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            var _a, _b, _c;
            return __generator(this, function (_d) {
     ...
     * Search NFT Ownerships
     */
    SearchControllerApi.prototype.searchOwnerships = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    SearchControllerApi.prototype.searchTraitsRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            var _a, _b, _c;
            return __generator(this, function (_d) {
     ...
     * Search NFT collection traits
     */
    SearchControllerApi.prototype.searchTraits = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    return SearchControllerApi;
}(runtime.BaseAPI));
exports.SearchControllerApi = SearchControllerApi;
