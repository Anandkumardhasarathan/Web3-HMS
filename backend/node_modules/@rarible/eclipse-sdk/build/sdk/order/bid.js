...
function bid(request) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const paymentTokenProgram = yield (0, utils_1.getTokenProgramFromMint)(request.connection, request.paymentMint.toString());
        ...
        const initializerPaymentTa = (0, utils_1.getAtaAddress)(request.paymentMint.toString(), initializer, paymentTokenProgram.toString());
        const orderPaymentTa = (0, utils_1.getAtaAddress)(request.paymentMint.toString(), order.toString(), paymentTokenProgram.toString());
        const instruction = yield marketProgram.methods
            ...
            market,
            nftMint: (_a = request.nftMint) !== null && _a !== void 0 ? _a : web3_js_1.PublicKey.default,
            order,
