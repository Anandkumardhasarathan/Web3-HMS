 ...
 * no description
 */
class BalanceControllerApi extends runtime.BaseAPI {
    /**
     * Return ERC20 token allowance
     */
    getErc20AllowanceRaw(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.contract === null || requestParameters.contract === undefined) {
                throw new runtime.RequiredError('contract', 'Required parameter requestParameters.contract was null or undefined when calling getErc20Allowance.');
            }
            if (requestParameters.owner === null || requestParameters.owner === undefined) {
                throw new runtime.RequiredError('owner', 'Required parameter requestParameters.owner was null or undefined when calling getErc20Allowance.');
            }
            ...
            const response = yield this.request({
                path: `/v0.1/erc20/balances/{contract}/{owner}/allowance`.replace(`{${"contract"}}`, encodeURIComponent(String(requestParameters.contract))).replace(`{${"owner"}}`, encodeURIComponent(String(requestParameters.owner))),
                method: 'GET',
     ...
     * Return ERC20 token allowance
     */
    getErc20Allowance(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getErc20AllowanceRaw(requestParameters);
            if (response.status === 200) {
     ...
     */
    getErc20BalanceRaw(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.contract === null || requestParameters.contract === undefined) {
     ...
     * Return ERC20 token balance
     */
    getErc20Balance(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getErc20BalanceRaw(requestParameters);
            if (response.status === 200) {
                return response.value;
            }
            throw response;
     ...
     * Return ETH balance
     */
    getEthBalanceRaw(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     * Return ETH balance
     */
    getEthBalance(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getEthBalanceRaw(requestParameters);
            if (response.status === 200) {
                return response.value;
            }
            throw response;
