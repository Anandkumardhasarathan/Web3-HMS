...
import { Erc20IndexerApiError, Erc20Token } from '../models';
export interface GetErc20TokenByIdRequest {
    contract: string;
}
/**
 * no description
 */
export declare class Erc20TokenControllerApi extends runtime.BaseAPI {
    /**
     * Return ERC20 token balance by ID
     */
    getErc20TokenByIdRaw(requestParameters: GetErc20TokenByIdRequest): Promise<GetErc20TokenByIdResponse>;
    /**
     * Return ERC20 token balance by ID
     */
    getErc20TokenById(requestParameters: GetErc20TokenByIdRequest): Promise<Erc20Token>;
}
export type GetErc20TokenById200 = {
    status: 200;
    value: Erc20Token;
};
export type GetErc20TokenById404 = {
    status: 404;
    value: Erc20IndexerApiError;
};
export type GetErc20TokenById400 = {
    status: 400;
    value: Erc20IndexerApiError;
};
export type GetErc20TokenById500 = {
    status: 500;
    value: Erc20IndexerApiError;
};
export type GetErc20TokenByIdResponse = GetErc20TokenById200 | GetErc20TokenById404 | GetErc20TokenById400 | GetErc20TokenById500;
