 ...
 * no description
 */
class Erc20TokenControllerApi extends runtime.BaseAPI {
    /**
     * Return ERC20 token balance by ID
     */
    getErc20TokenByIdRaw(requestParameters) {
     ...
     * Return ERC20 token balance by ID
     */
    getErc20TokenById(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getErc20TokenByIdRaw(requestParameters);
            if (response.status === 200) {
