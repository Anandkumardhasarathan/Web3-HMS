 ...
 * no description
 */
class GatewayControllerApi extends runtime.BaseAPI {
    /**
     */
    createGatewayPendingTransactionsRaw(requestParameters) {
    ...
    /**
     */
    createGatewayPendingTransactions(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.createGatewayPendingTransactionsRaw(requestParameters);
            if (response.status === 200) {
