...
import { ActivitiesByIdRequest, EthereumApiErrorBadRequest, EthereumApiErrorServerError, NftActivities, SyncSort } from '../models';
export interface GetNftActivitiesByIdRequest {
    activitiesByIdRequest: ActivitiesByIdRequest;
}
 ...
 * no description
 */
export declare class NftActivityControllerApi extends runtime.BaseAPI {
    /**
     */
    getNftActivitiesByIdRaw(requestParameters: GetNftActivitiesByIdRequest): Promise<GetNftActivitiesByIdResponse>;
    /**
     */
    getNftActivitiesById(requestParameters: GetNftActivitiesByIdRequest): Promise<NftActivities>;
    /**
     */
    getNftActivitiesSyncRaw(requestParameters: GetNftActivitiesSyncRequest): Promise<GetNftActivitiesSyncResponse>;
    /**
     */
    getNftActivitiesSync(requestParameters: GetNftActivitiesSyncRequest): Promise<NftActivities>;
}
export type GetNftActivitiesById200 = {
    status: 200;
    value: NftActivities;
};
export type GetNftActivitiesById400 = {
    status: 400;
    value: EthereumApiErrorBadRequest;
};
export type GetNftActivitiesById500 = {
    status: 500;
    value: EthereumApiErrorServerError;
};
export type GetNftActivitiesByIdResponse = GetNftActivitiesById200 | GetNftActivitiesById400 | GetNftActivitiesById500;
export type GetNftActivitiesSync200 = {
    status: 200;
    value: NftActivities;
};
export type GetNftActivitiesSync400 = {
    status: 400;
    value: EthereumApiErrorBadRequest;
};
export type GetNftActivitiesSync500 = {
    status: 500;
    value: EthereumApiErrorServerError;
};
export type GetNftActivitiesSyncResponse = GetNftActivitiesSync200 | GetNftActivitiesSync400 | GetNftActivitiesSync500;
