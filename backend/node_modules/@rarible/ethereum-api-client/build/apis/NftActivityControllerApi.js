 ...
 * no description
 */
class NftActivityControllerApi extends runtime.BaseAPI {
    /**
     */
    getNftActivitiesByIdRaw(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.activitiesByIdRequest === null || requestParameters.activitiesByIdRequest === undefined) {
                throw new runtime.RequiredError('activitiesByIdRequest', 'Required parameter requestParameters.activitiesByIdRequest was null or undefined when calling getNftActivitiesById.');
            }
    ...
    /**
     */
    getNftActivitiesById(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getNftActivitiesByIdRaw(requestParameters);
            if (response.status === 200) {
    ...
    /**
     */
    getNftActivitiesSyncRaw(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
    ...
    /**
     */
    getNftActivitiesSync(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getNftActivitiesSyncRaw(requestParameters);
            if (response.status === 200) {
                return response.value;
            }
            throw response;
