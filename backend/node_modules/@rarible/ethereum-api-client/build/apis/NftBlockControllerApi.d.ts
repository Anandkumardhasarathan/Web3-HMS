...
import { EthereumApiErrorEntityNotFound, EthereumApiErrorServerError, LatestIndexedBlock } from '../models';
/**
 * no description
 */
export declare class NftBlockControllerApi extends runtime.BaseAPI {
    /**
     * Get latest indexed block
     */
    getLatestIndexedBlockRaw(): Promise<GetLatestIndexedBlockResponse>;
    /**
     * Get latest indexed block
     */
    getLatestIndexedBlock(): Promise<LatestIndexedBlock>;
}
...
export type GetLatestIndexedBlockResponse = GetLatestIndexedBlock200 | GetLatestIndexedBlock404 | GetLatestIndexedBlock500;
