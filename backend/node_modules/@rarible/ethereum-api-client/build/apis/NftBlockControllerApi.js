...
exports.NftBlockControllerApi = void 0;
const runtime = __importStar(require("../runtime"));
/**
 * no description
 */
class NftBlockControllerApi extends runtime.BaseAPI {
    /**
     * Get latest indexed block
     */
    getLatestIndexedBlockRaw() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                path: `/v0.1/nft/blocks/latest-indexed`,
                method: 'GET',
    ...
    getLatestIndexedBlock() {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getLatestIndexedBlockRaw();
            if (response.status === 200) {
...
exports.NftBlockControllerApi = NftBlockControllerApi;
