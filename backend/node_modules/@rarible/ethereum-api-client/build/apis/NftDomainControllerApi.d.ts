...
import { DomainResolveResult, EthereumApiErrorBadRequest, EthereumApiErrorEntityNotFound, EthereumApiErrorServerError, NftDomain } from '../models';
export interface GetDomainByIdRequest {
    domainId: string;
}
export interface ResolveDomainByNameRequest {
    domain: string;
}
/**
 * no description
 */
export declare class NftDomainControllerApi extends runtime.BaseAPI {
    /**
     * Get domain by id
     */
    getDomainByIdRaw(requestParameters: GetDomainByIdRequest): Promise<GetDomainByIdResponse>;
    /**
     * Get domain by id
     */
    getDomainById(requestParameters: GetDomainByIdRequest): Promise<NftDomain>;
    /**
     * Resolve domain by name
     */
    resolveDomainByNameRaw(requestParameters: ResolveDomainByNameRequest): Promise<ResolveDomainByNameResponse>;
    /**
     * Resolve domain by name
     */
    resolveDomainByName(requestParameters: ResolveDomainByNameRequest): Promise<DomainResolveResult>;
}
export type GetDomainById200 = {
    status: 200;
    value: NftDomain;
};
export type GetDomainById404 = {
    status: 404;
    value: EthereumApiErrorEntityNotFound;
};
export type GetDomainById400 = {
    status: 400;
    value: EthereumApiErrorBadRequest;
};
export type GetDomainById500 = {
    status: 500;
    value: EthereumApiErrorServerError;
};
export type GetDomainByIdResponse = GetDomainById200 | GetDomainById404 | GetDomainById400 | GetDomainById500;
export type ResolveDomainByName200 = {
    status: 200;
    value: DomainResolveResult;
};
export type ResolveDomainByName400 = {
    status: 400;
    value: EthereumApiErrorBadRequest;
};
export type ResolveDomainByName500 = {
    status: 500;
    value: EthereumApiErrorServerError;
};
export type ResolveDomainByNameResponse = ResolveDomainByName200 | ResolveDomainByName400 | ResolveDomainByName500;
