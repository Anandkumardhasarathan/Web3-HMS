 ...
 * no description
 */
class NftLazyMintControllerApi extends runtime.BaseAPI {
    /**
     * Lazy mint of NFT
     */
    mintNftAssetRaw(requestParameters) {
     ...
     * Lazy mint of NFT
     */
    mintNftAsset(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.mintNftAssetRaw(requestParameters);
            if (response.status === 200) {
