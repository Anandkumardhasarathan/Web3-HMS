 ...
 * no description
 */
class NftTransactionControllerApi extends runtime.BaseAPI {
    /**
     * Create pending transaction for NFT
     */
    createNftPendingTransactionRaw(requestParameters) {
     ...
     * Create pending transaction for NFT
     */
    createNftPendingTransaction(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.createNftPendingTransactionRaw(requestParameters);
            if (response.status === 200) {
