 ...
 * no description
 */
class OrderActivityControllerApi extends runtime.BaseAPI {
    /**
     */
    getOrderActivitiesByIdRaw(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.activitiesByIdRequest === null || requestParameters.activitiesByIdRequest === undefined) {
                throw new runtime.RequiredError('activitiesByIdRequest', 'Required parameter requestParameters.activitiesByIdRequest was null or undefined when calling getOrderActivitiesById.');
            }
            ...
            const response = yield this.request({
                ...
                body: requestParameters.activitiesByIdRequest,
            });
    ...
    /**
     */
    getOrderActivitiesById(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getOrderActivitiesByIdRaw(requestParameters);
            if (response.status === 200) {
     ...
     */
    getOrderActivitiesSyncRaw(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
     ...
     * Returns event history with order
     */
    getOrderActivitiesSync(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getOrderActivitiesSyncRaw(requestParameters);
            if (response.status === 200) {
                return response.value;
            }
            throw response;
    ...
    /**
     * Returns reverted event history with order
     */
    getOrderRevertedActivitiesSyncRaw(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            if (requestParameters.continuation !== undefined) {
                queryParameters['continuation'] = requestParameters.continuation;
            ...
            const response = yield this.request({
                path: `/v0.1/order/activities/reverted/sync`,
                method: 'GET',
                headers: headerParameters,
                query: queryParameters,
            });
     ...
     * Returns reverted event history with order
     */
    getOrderRevertedActivitiesSync(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getOrderRevertedActivitiesSyncRaw(requestParameters);
            if (response.status === 200) {
                return response.value;
            }
            throw response;
