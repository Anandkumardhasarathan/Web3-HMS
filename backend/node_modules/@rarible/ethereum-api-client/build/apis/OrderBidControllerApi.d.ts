...
export type GetBidsByItem200 = {
    status: 200;
    value: OrderBidsPagination;
};
export type GetBidsByItem400 = {
    status: 400;
    value: EthereumApiErrorBadRequest;
};
export type GetBidsByItem500 = {
    status: 500;
    value: EthereumApiErrorServerError;
};
export type GetBidsByItemResponse = GetBidsByItem200 | GetBidsByItem400 | GetBidsByItem500;
