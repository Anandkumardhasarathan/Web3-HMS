 ...
 * no description
 */
class OrderBidControllerApi extends runtime.BaseAPI {
    /**
     */
    getBidsByItemRaw(requestParameters) {
    ...
    /**
     */
    getBidsByItem(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getBidsByItemRaw(requestParameters);
            if (response.status === 200) {
