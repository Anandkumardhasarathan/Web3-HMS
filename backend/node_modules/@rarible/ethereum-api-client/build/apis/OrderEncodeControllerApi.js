...
class OrderEncodeControllerApi extends runtime.BaseAPI {
     ...
     * Deprecated. Use Rarible Protocol Ethereum SDK https://github.com/rarible/ethereum-sdk/tree/master
     */
    encodeOrder(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.encodeOrderRaw(requestParameters);
            if (response.status === 200) {
     ...
     */
    encodeOrderAssetTypeRaw(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * This method should not be used and will be removed soon
     */
    encodeOrderAssetType(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.encodeOrderAssetTypeRaw(requestParameters);
            if (response.status === 200) {
                return response.value;
            }
            throw response;
     ...
     * This method should not be used and will be removed soon
     */
    encodeOrderDataRaw(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * This method should not be used and will be removed soon
     */
    encodeOrderData(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.encodeOrderDataRaw(requestParameters);
            if (response.status === 200) {
                return response.value;
            }
            throw response;
