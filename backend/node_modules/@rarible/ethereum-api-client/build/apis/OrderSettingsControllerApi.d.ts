...
import { EthOrderFees, EthereumApiErrorServerError } from '../models';
/**
 * no description
 */
export declare class OrderSettingsControllerApi extends runtime.BaseAPI {
    /**
     * Returns set fees for different order types
     */
    getFeesRaw(): Promise<GetFeesResponse>;
    /**
     * Returns set fees for different order types
     */
    getFees(): Promise<EthOrderFees>;
}
export type GetFees200 = {
    status: 200;
    value: EthOrderFees;
};
export type GetFees500 = {
    status: 500;
    value: EthereumApiErrorServerError;
};
export type GetFeesResponse = GetFees200 | GetFees500;
