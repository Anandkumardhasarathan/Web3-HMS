...
exports.OrderSettingsControllerApi = void 0;
const runtime = __importStar(require("../runtime"));
/**
 * no description
 */
class OrderSettingsControllerApi extends runtime.BaseAPI {
    /**
    ...
    getFeesRaw() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                path: `/v0.1/order/orders/settings/fees`,
                method: 'GET',
    ...
    getFees() {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getFeesRaw();
            if (response.status === 200) {
...
exports.OrderSettingsControllerApi = OrderSettingsControllerApi;
