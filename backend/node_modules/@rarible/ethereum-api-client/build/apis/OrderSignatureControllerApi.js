 ...
 * no description
 */
class OrderSignatureControllerApi extends runtime.BaseAPI {
    /**
     * Fetch x2y2 cancel sign
     */
    cancelSignX2Y2Raw(requestParameters) {
     ...
     * Fetch x2y2 cancel sign
     */
    cancelSignX2Y2(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.cancelSignX2Y2Raw(requestParameters);
            if (response.status === 200) {
     ...
     */
    orderSignX2Y2Raw(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * Fetch x2y2 order sign
     */
    orderSignX2Y2(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.orderSignX2Y2Raw(requestParameters);
            if (response.status === 200) {
                return response.value;
            }
            throw response;
