 ...
 * no description
 */
class OrderTransactionControllerApi extends runtime.BaseAPI {
    /**
     * Create pending transaction for order
     */
    createOrderPendingTransactionRaw(requestParameters) {
     ...
     * Create pending transaction for order
     */
    createOrderPendingTransaction(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.createOrderPendingTransactionRaw(requestParameters);
            if (response.status === 200) {
