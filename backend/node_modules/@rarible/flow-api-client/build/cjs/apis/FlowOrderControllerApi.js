...
exports.GetOrdersSyncSortEnum = exports.FlowOrderControllerApi = void 0;
...
var FlowOrderControllerApi = /** @class */ (function (_super) {
    tslib_1.__extends(FlowOrderControllerApi, _super);
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                path: "/v0.1/orders/{orderId}".replace("{" + "orderId" + "}", encodeURIComponent(String(requestParameters.orderId))),
                                method: 'GET',
    ...
    /**
     */
    FlowOrderControllerApi.prototype.getOrdersSyncRaw = function (requestParameters) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response, _a, _b, _c;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
    ...
    /**
     */
    FlowOrderControllerApi.prototype.getOrdersSync = function (requestParameters) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var response;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getOrdersSyncRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
                        if (response.status === 200) {
                            return [2 /*return*/, response.value];
            ...
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        headerParameters = {};
                        return [4 /*yield*/, this.request({
                                path: "/v0.1/orders/sell/currencies/{itemId}".replace("{" + "itemId" + "}", encodeURIComponent(String(requestParameters.itemId))),
                                method: 'GET',
                                headers: headerParameters,
                                query: queryParameters,
                            })];
...
/**
    ...
    * @enum {string}
    */
var GetOrdersSyncSortEnum;
(function (GetOrdersSyncSortEnum) {
    GetOrdersSyncSortEnum["DESC"] = "UPDATED_AT_DESC";
    GetOrdersSyncSortEnum["ASC"] = "UPDATED_AT_ASC";
})(GetOrdersSyncSortEnum = exports.GetOrdersSyncSortEnum || (exports.GetOrdersSyncSortEnum = {}));
