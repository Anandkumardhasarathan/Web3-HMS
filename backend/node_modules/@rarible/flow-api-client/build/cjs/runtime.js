...
exports.BASE_PATH = "https://flow-api.rarible.org".replace(/\/+$/, "");
...
var BaseAPI = /** @class */ (function () {
    function BaseAPI(configuration) {
        ...
        this.fetchApi = function (url, init) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, middleware.pre(tslib_1.__assign({ fetch: this.fetchApi }, fetchParams))];
                    case 2:
...
function mapValues(data, fn) {
    return Object.keys(data).reduce(function (acc, key) {
        var _a;
        return (tslib_1.__assign(tslib_1.__assign({}, acc), (_a = {}, _a[key] = fn(data[key]), _a)));
    }, {});
}
