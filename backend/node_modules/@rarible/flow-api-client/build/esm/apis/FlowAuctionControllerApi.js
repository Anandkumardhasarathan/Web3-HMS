 ...
 * no description
 */
var FlowAuctionControllerApi = /** @class */ (function (_super) {
    __extends(FlowAuctionControllerApi, _super);
    function FlowAuctionControllerApi() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    /**
     * Returns auction bids by the auction id
     */
    FlowAuctionControllerApi.prototype.getAuctionBidsByIdRaw = function (requestParameters) {
     ...
     * Returns auction bids by the auction id
     */
    FlowAuctionControllerApi.prototype.getAuctionBidsById = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
     ...
     */
    FlowAuctionControllerApi.prototype.getAuctionByIdRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     * Return auction by id
     */
    FlowAuctionControllerApi.prototype.getAuctionById = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    FlowAuctionControllerApi.prototype.getAuctionsByCollectionRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response, _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
     ...
     * Returns all auctions by collection
     */
    FlowAuctionControllerApi.prototype.getAuctionsByCollection = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    /**
     * Returns all auctions by auction id\'s
     */
    FlowAuctionControllerApi.prototype.getAuctionsByIdsRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response, _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        if (requestParameters.flowAuctionIds === null || requestParameters.flowAuctionIds === undefined) {
                            throw new runtime.RequiredError('flowAuctionIds', 'Required parameter requestParameters.flowAuctionIds was null or undefined when calling getAuctionsByIds.');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        headerParameters['Content-Type'] = 'application/json';
                        return [4 /*yield*/, this.request({
                                path: "/v0.1/auctions/byIds",
                                method: 'POST',
                                headers: headerParameters,
                                query: queryParameters,
                                body: requestParameters.flowAuctionIds,
                            })];
                    case 1:
                        response = _d.sent();
                        if (!(response.status === 200)) return [3 /*break*/, 3];
     ...
     * Returns all auctions by auction id\'s
     */
    FlowAuctionControllerApi.prototype.getAuctionsByIds = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getAuctionsByIdsRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
                        if (response.status === 200) {
                            return [2 /*return*/, response.value];
     ...
     */
    FlowAuctionControllerApi.prototype.getAuctionsByItemRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response, _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        if (requestParameters.contract === null || requestParameters.contract === undefined) {
                            throw new runtime.RequiredError('contract', 'Required parameter requestParameters.contract was null or undefined when calling getAuctionsByItem.');
                        }
                        if (requestParameters.tokenId === null || requestParameters.tokenId === undefined) {
                            throw new runtime.RequiredError('tokenId', 'Required parameter requestParameters.tokenId was null or undefined when calling getAuctionsByItem.');
                        }
                        queryParameters = {};
                        if (requestParameters.contract !== undefined) {
                            queryParameters['contract'] = requestParameters.contract;
     ...
     * Returns all auctions by item
     */
    FlowAuctionControllerApi.prototype.getAuctionsByItem = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    FlowAuctionControllerApi.prototype.getAuctionsBySellerRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response, _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
     ...
     * Returns all auctions by seller
     */
    FlowAuctionControllerApi.prototype.getAuctionsBySeller = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    return FlowAuctionControllerApi;
}(runtime.BaseAPI));
export { FlowAuctionControllerApi };
