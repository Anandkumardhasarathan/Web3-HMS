 ...
 * no description
 */
var FlowBidOrderControllerApi = /** @class */ (function (_super) {
    __extends(FlowBidOrderControllerApi, _super);
    function FlowBidOrderControllerApi() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    /**
     */
    FlowBidOrderControllerApi.prototype.getBidCurrenciesRaw = function (requestParameters) {
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                path: "/v0.1/bids/currencies/{itemId}".replace("{" + "itemId" + "}", encodeURIComponent(String(requestParameters.itemId))),
                                method: 'GET',
    ...
    /**
     */
    FlowBidOrderControllerApi.prototype.getBidCurrencies = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
    ...
    /**
     */
    FlowBidOrderControllerApi.prototype.getBidsByItemRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response, _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
    ...
    /**
     */
    FlowBidOrderControllerApi.prototype.getBidsByItem = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    /**
     */
    FlowBidOrderControllerApi.prototype.getOrderBidsByMakerRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response, _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
    ...
    /**
     */
    FlowBidOrderControllerApi.prototype.getOrderBidsByMaker = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    return FlowBidOrderControllerApi;
}(runtime.BaseAPI));
export { FlowBidOrderControllerApi };
