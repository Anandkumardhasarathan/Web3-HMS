...
import { FlowApiError, FlowNftCollection, FlowNftCollections } from '../models';
...
export interface SearchNftCollectionsByIdsRequest {
    ids: Array<string>;
}
 ...
 * no description
 */
export declare class FlowNftCollectionControllerApi extends runtime.BaseAPI {
    /**
     ...
     * Returns Collection by ID
     */
    getNftCollectionById(requestParameters: GetNftCollectionByIdRequest): Promise<FlowNftCollection>;
    /**
     */
    searchNftAllCollectionsRaw(requestParameters: SearchNftAllCollectionsRequest): Promise<SearchNftAllCollectionsResponse>;
    /**
     */
    searchNftAllCollections(requestParameters: SearchNftAllCollectionsRequest): Promise<FlowNftCollections>;
    /**
     */
    searchNftCollectionsByIdsRaw(requestParameters: SearchNftCollectionsByIdsRequest): Promise<SearchNftCollectionsByIdsResponse>;
    /**
     */
    searchNftCollectionsByIds(requestParameters: SearchNftCollectionsByIdsRequest): Promise<FlowNftCollections>;
    /**
     */
    ...
    /**
     */
    searchNftCollectionsByOwner(requestParameters: SearchNftCollectionsByOwnerRequest): Promise<FlowNftCollections>;
}
export declare type GetNftCollectionById200 = {
    status: 200;
    value: FlowNftCollection;
};
...
export declare type SearchNftCollectionsByIds200 = {
    status: 200;
    value: FlowNftCollections;
};
export declare type SearchNftCollectionsByIds500 = {
    status: 500;
    value: FlowApiError;
};
export declare type SearchNftCollectionsByIdsResponse = SearchNftCollectionsByIds200 | SearchNftCollectionsByIds500;
