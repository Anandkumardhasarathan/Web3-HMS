...
import { FlowApiError, FlowAsset, FlowOrder, FlowOrderIds, FlowOrderStatus, FlowOrdersPagination } from '../models';
...
export interface GetOrdersAllByStatusRequest {
    ...
    continuation?: string;
    size?: number;
    status?: Array<FlowOrderStatus>;
}
export interface GetOrdersByIdsRequest {
    flowOrderIds: FlowOrderIds;
}
export interface GetOrdersSyncRequest {
    continuation?: string;
    size?: number;
    sort?: GetOrdersSyncSortEnum;
}
...
export declare class FlowOrderControllerApi extends runtime.BaseAPI {
    ...
    /**
     */
    getOrdersSyncRaw(requestParameters: GetOrdersSyncRequest): Promise<GetOrdersSyncResponse>;
    /**
     */
    getOrdersSync(requestParameters: GetOrdersSyncRequest): Promise<FlowOrdersPagination>;
    /**
     */
...
export declare type GetOrdersSync200 = {
    status: 200;
    value: FlowOrdersPagination;
};
export declare type GetOrdersSync400 = {
    status: 400;
    value: FlowApiError;
};
export declare type GetOrdersSync500 = {
    status: 500;
    value: FlowApiError;
};
export declare type GetOrdersSyncResponse = GetOrdersSync200 | GetOrdersSync400 | GetOrdersSync500;
/**
    * @export
    * @enum {string}
    */
export declare enum GetOrdersSyncSortEnum {
