...
export interface ConfigurationParameters<T extends FetchAPI = FetchAPI> {
    basePath?: string;
    fetchApi?: FetchAPI;
    exceptionHandler?: (error: Error, url: string, init: RequestInit) => Promise<ReturnType<T> | undefined>;
...
export declare class Configuration {
    ...
    get exceptionHandler(): ((error: Error, url: string, init: RequestInit) => Promise<Promise<Response> | undefined>) | (() => undefined);
