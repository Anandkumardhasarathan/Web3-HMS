...
function getFtCodeConfig(contract) {
    ...
    switch (contract) {
        case "FUSD":
            return tslib_1.__assign(tslib_1.__assign({}, knownConf), { "%ftBalancePublicPath%": "/public/fusdBalance", "%ftPublicPath%": "/public/fusdReceiver", "%ftStoragePath%": "/storage/fusdVault" });
        case "FiatToken":
            return tslib_1.__assign(tslib_1.__assign({}, knownConf), { "%ftBalancePublicPath%": "FiatToken.VaultBalancePubPath", "%ftPublicPath%": "FiatToken.VaultReceiverPubPath", "%ftStoragePath%": "FiatToken.VaultStoragePath" });
        case "FlowToken":
            return tslib_1.__assign(tslib_1.__assign({}, knownConf), { "%ftBalancePublicPath%": "/public/flowTokenBalance", "%ftPublicPath%": "/public/flowTokenReceiver", "%ftStoragePath%": "/storage/flowTokenVault" });
        default:
...
function getNftCodeConfig(contract) {
    ...
    return tslib_1.__assign(tslib_1.__assign({}, staticConfig), { "%nftContract%": contract, "%nftStorageType%": "".concat(contract, ".Collection"), "%nftPrivatePath%": staticConfig["%nftPrivatePath%"] || "/private/".concat(contract, "_collectionRef"), "%nftPrivateType%": "NonFungibleToken.CollectionPublic,NonFungibleToken.Provider,NonFungibleToken.Receiver", "%nftPublicType%": "".concat(staticConfig["%publicTypeAddon%"] ? staticConfig["%publicTypeAddon%"] + "," : "", "NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver"), "%nftPublicTypeMin%": staticConfig["%publicTypeAddon%"] || "NonFungibleToken.CollectionPublic" });
}
