...
var feesArray = [{ account: types_1.FLOW_ZERO_ADDRESS, value: (0, types_1.toBigNumberLike)("0.1") }];
/** Create SDK */
var sdk = (0, index_1.createFlowSdk)(fcl, "mainnet");
/** Nft features: mint, burn, transfer */
var collection = (0, types_1.toFlowContractAddress)(config_1.TestnetCollections.RARIBLE);
...
sdk.order.sell({
    ...
    sellItemPrice: (0, types_1.toBigNumberLike)("0.3"),
    currency: "FLOW",
...
sdk.order.updateOrder({
    ...
    currency: "FUSD",
    order: "123",
    sellItemPrice: (0, types_1.toBigNumberLike)("0.1"),
}).then(function (response) {
    console.log("order id: ", response.orderId);
});
...
sdk.order.bid(collection, "FLOW", (0, index_1.toFlowItemId)("flow item id"), (0, types_1.toBigNumberLike)("0.1")).then(function (response) {
    console.log("bid order id: ", response.orderId);
});
sdk.order.bidUpdate(collection, "FLOW", "123", (0, types_1.toBigNumberLike)("0.1")).then(function (response) {
    console.log("bid order id: ", response.orderId);
});
