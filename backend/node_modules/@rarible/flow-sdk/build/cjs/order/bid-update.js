        ...
        return tslib_1.__generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 5:
                    ...
                    orderId = (0, get_order_id_1.getOrderId)(preparedOrder.id);
                    return [4 /*yield*/, (0, get_order_details_from_blockchain_1.getOrderDetailsFromBlockchain)(fcl, network, "bid", from, orderId)];
                case 6:
                    bidSaleCuts = _e.sent();
                    return [4 /*yield*/, (0, transaction_1.runTransaction)(fcl, map, (0, rarible_open_bid_1.getBidCode)(fcl, name_1).update(currency, orderId, (0, fix_amount_1.fixAmount)(price), (0, calculate_update_order_sale_cuts_1.calculateUpdateOrderSaleCuts)(preparedOrder.make.value, price, bidSaleCuts.saleCuts)), auth)];
                case 7:
                    txId = _e.sent();
                ...
                case 8:
                    ...
                    return [2 /*return*/, tslib_1.__assign(tslib_1.__assign({}, txResponse), { orderId: simpleOrderId })];
