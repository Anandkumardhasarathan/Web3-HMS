        ...
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, transaction_1.runTransaction)(fcl, map, (0, rarible_open_bid_1.getBidCode)(fcl, name_1).create(currency, (0, item_1.extractTokenId)(itemId), (0, fix_amount_1.fixAmount)(price), tslib_1.__spreadArray([], (0, calculate_fees_1.calculateFees)(price, tslib_1.__spreadArray(tslib_1.__spreadArray([], protocolFees, true), requestFees, true)), true)), auth)];
                case 1:
                    txId = _b.sent();
