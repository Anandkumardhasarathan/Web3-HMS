...
function calculateSaleCuts(mainPayoutAddress, price, fees, payouts) {
    ...
    var resultFeeSaleCuts = fees.map(function (fee) {
        ...
        return tslib_1.__assign(tslib_1.__assign({}, fee), { value: (0, types_1.toBigNumberLike)(value.decimalPlaces(8).toString()) });
    });
    ...
    if (leftAfterPayouts.gt(0)) {
        resultPayoutSaleCuts.push({
            ...
            value: (0, types_1.toBigNumberLike)(leftAfterPayouts.decimalPlaces(8).toString()),
        });
    }
    else if (leftAfterPayouts.lt(0)) {
        throw new Error("Sum of payouts greater than price");
    }
    return concatNonUniqueFees(tslib_1.__spreadArray(tslib_1.__spreadArray([], resultFeeSaleCuts, true), resultPayoutSaleCuts, true));
}
...
function concatNonUniqueFees(fees) {
    ...
    return Object.keys(unique).map(function (k) { return ({ account: (0, types_1.toFlowAddress)(k), value: (0, types_1.toBigNumberLike)(unique[k]) }); });
}
