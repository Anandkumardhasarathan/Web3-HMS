...
var storefront_1 = require("../../scripts/storefront/storefront");
...
function getOrderCode(fcl, collectionName) {
    return {
        create: function (currency, itemId, fees) {
            return {
                cadence: (0, prepare_order_code_1.prepareOrderCode)(storefront_1.Storefront.createSellOrder, collectionName, currency),
                args: fcl.args([
        ...
        update: function (currency, orderId, fees) {
            return {
                cadence: (0, prepare_order_code_1.prepareOrderCode)(storefront_1.Storefront.updateOrder, collectionName, currency),
                args: fcl.args([
        ...
        buy: function (currency, orderId, address, fees) {
            return {
                cadence: (0, prepare_order_code_1.prepareOrderCode)(storefront_1.Storefront.buy, collectionName, currency),
                args: fcl.args([
        ...
        cancel: function (orderId) {
            return {
                cadence: storefront_1.Storefront.cancelOrder,
