...
function httpRequest(_a) {
    return tslib_1.__awaiter(this, arguments, void 0, function (_b) {
        ...
        var hostname = _b.hostname, path = _b.path, method = _b.method, body = _b.body;
        return tslib_1.__generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    _c.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, Promise.resolve().then(function () { return tslib_1.__importStar(require("https")); }).catch(function () { return undefined; })];
                case 2:
                    nodeHttpsTransport = _c.sent();
                    return [3 /*break*/, 4];
                case 3:
                    e_1 = _c.sent();
                    return [3 /*break*/, 4];
                case 4:
                    _c.trys.push([4, 6, , 7]);
                    return [4 /*yield*/, Promise.resolve().then(function () { return tslib_1.__importStar(require("http")); }).catch(function () { return undefined; })];
                case 5:
                    nodeHttpTransport = _c.sent();
                    return [3 /*break*/, 7];
                case 6:
                    e_2 = _c.sent();
                    return [3 /*break*/, 7];
