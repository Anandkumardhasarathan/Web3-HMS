...
export declare const NODE_TRANSPORT_CONFIG: Record<FlowNetwork, string>;
export declare const METADATA_HOST = "https://gateway.pinata.cloud";
...
export declare const flowCollectionsConfig: Record<NonFungibleContract, FlowConfigData>;
