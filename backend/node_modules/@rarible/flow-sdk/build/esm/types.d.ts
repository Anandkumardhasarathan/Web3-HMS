...
export declare const NON_FUNGIBLE_CONTRACTS: readonly ["RaribleNFT", "Evolution", "MotoGPCard", "TopShot", "MugenNFT", "CNN_NFT", "MatrixWorldFlowFestNFT", "MatrixWorldVoucher", "DisruptArt", "Art", "StarlyCard", "OneFootballCollectible", "ChainmonstersRewards", "BarterYardPackNFT", "Moments", "FanfareNFTContract", "Kicks", "SomePlaceCollectible", "IrNFT", "IrVoucher", "GeniaceNFT", "CryptoPiggo", "HWGaragePack", "HWGaragePackV2", "HWGarageCard", "HWGarageCardV2", "HWGarageTokenV2", "BBxBarbiePack", "BBxBarbieCard", "BBxBarbieToken", "Gamisodes"];
...
export type FlowContractName = NonFungibleTokenType | FungibleTokenType | NFTStorefrontType | NFTStorefrontV2 | RaribleFeeType | RaribleOrderType | LicensedNFTType | TopShotFeeType | RaribleOpenBid | MetadataViews | FungibleContracts | NonFungibleContract | TokenForwarding | NiftoryNFTRegistry | NiftoryNonFungibleToken;
