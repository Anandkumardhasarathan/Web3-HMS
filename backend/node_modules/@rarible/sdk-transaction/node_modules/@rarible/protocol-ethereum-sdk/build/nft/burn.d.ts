...
export declare function burn(ethereum: Maybe<Ethereum>, send: SendFunction, checkAssetType: CheckAssetTypeFunction, getApis: () => Promise<RaribleEthereumApis>, request: BurnRequest): Promise<EthereumTransaction | void>;
