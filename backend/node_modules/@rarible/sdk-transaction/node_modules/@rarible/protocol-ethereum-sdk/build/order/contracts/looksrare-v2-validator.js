...
exports.LOOKSRARE_V2_VALIDATOR_ABI = exports.createLooksrareV2Validator = void 0;
function createLooksrareV2Validator(ethereum, address) {
    return ethereum.createContract(exports.LOOKSRARE_V2_VALIDATOR_ABI, address);
}
exports.createLooksrareV2Validator = createLooksrareV2Validator;
exports.LOOKSRARE_V2_VALIDATOR_ABI = [
    {
        inputs: [
            {
