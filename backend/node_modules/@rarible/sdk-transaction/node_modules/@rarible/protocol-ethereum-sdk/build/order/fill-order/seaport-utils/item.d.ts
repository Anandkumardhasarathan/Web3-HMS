...
export declare const getSummedTokenAndIdentifierAmounts: ({ items, criterias, timeBasedItemParams, }: {
    ...
    timeBasedItemParams?: TimeBasedItemParams;
}) => Record<string, Record<string, import("bignumber.js").default>>;
/**
 ...
 */
export declare const getMaximumSizeForOrder: ({ parameters: { offer, consideration } }: Order) => import("bignumber.js").default;
