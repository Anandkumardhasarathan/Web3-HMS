 ...
 */
export declare function getFlowCollection(collection: UnionContractAddress | CollectionId): FlowContractAddress;
/**
 * Parse union item id
 ...
 */
export declare function parseOrderId(id: string): string;
/**
 * Get fungible token name
 * @param contract - e.g. "FLOW:A.0xabcdef0123456789.ContractName", contract address can be unprefixed
 */
export declare function getFungibleTokenName(contract: UnionContractAddress): FlowCurrency;
...
export declare function convertFlowOrderId(orderId: string): OrderId;
export declare function convertFlowItemId(itemId: FlowItemIdSdk): ItemId;
export declare function convertFlowContractAddress(contractAddress: string): UnionContractAddress;
