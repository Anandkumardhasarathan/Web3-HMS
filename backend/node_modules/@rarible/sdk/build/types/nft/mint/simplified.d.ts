...
export type MintSimplifiedRequestOnChain = Omit<MintRequest, "lazyMint"> & PrepareMintRequest & {
    lazyMint?: false;
};
export type MintSimplifiedRequestOffChain = Omit<MintRequest, "lazyMint"> & PrepareMintRequest & {
    lazyMint: true;
};
