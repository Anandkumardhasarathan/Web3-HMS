...
export interface PrepareFillResponse extends AbstractPrepareResponse<FillActionTypes, FillRequest, IBlockchainTransaction>, PreparedFillInfo {
}
/**
 * Fill sell/bid order
 *
...
export type BatchFillSingleRequest = {
    orderId: OrderId;
} & FillRequest;
export type BatchFillRequest = BatchFillSingleRequest[];
type BatchSinglePrepared = {
    orderId: OrderId;
} & PreparedFillInfo;
export interface PrepareBatchBuyResponse extends AbstractPrepareResponse<FillActionTypes, BatchFillRequest, IBlockchainTransaction<Blockchain, IBatchBuyTransactionResult>> {
    prepared: BatchSinglePrepared[];
}
export type IBatchBuyPrepare = (request: PrepareFillRequest[]) => Promise<PrepareBatchBuyResponse>;
export type IBatchBuySimplified = (request: BatchFillRequest) => Promise<IBlockchainTransaction<Blockchain, IBatchBuyTransactionResult>>;
export {};
