...
exports.LOOKSRARE_ABI = exports.createLooksrareExchange = void 0;
function createLooksrareExchange(ethereum, address) {
    return ethereum.createContract(exports.LOOKSRARE_ABI, address);
}
exports.createLooksrareExchange = createLooksrareExchange;
exports.LOOKSRARE_ABI = [
    {
        inputs: [
            {
