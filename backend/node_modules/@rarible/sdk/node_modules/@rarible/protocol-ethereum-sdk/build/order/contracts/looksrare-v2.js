...
exports.LOOKSRARE_V2_ABI = exports.createLooksrareV2Exchange = void 0;
function createLooksrareV2Exchange(ethereum, address) {
    return ethereum.createContract(exports.LOOKSRARE_V2_ABI, address);
}
exports.createLooksrareV2Exchange = createLooksrareV2Exchange;
exports.LOOKSRARE_V2_ABI = [
    {
        inputs: [
            {
