...
exports.SUDOSWAP_ROUTER_V1_ABI = exports.createSudoswapRouterV1Contract = void 0;
function createSudoswapRouterV1Contract(ethereum, address) {
    return ethereum.createContract(exports.SUDOSWAP_ROUTER_V1_ABI, address);
}
exports.createSudoswapRouterV1Contract = createSudoswapRouterV1Contract;
exports.SUDOSWAP_ROUTER_V1_ABI = [
    {
        inputs: [
            {
