...
const getPresentItemAmount = ({ startAmount, endAmount, timeBasedItemParams, }) => {
    const startAmountBn = (0, utils_2.toBn)(startAmount);
    const endAmountBn = (0, utils_2.toBn)(endAmount);
    ...
    const duration = (0, utils_2.toBn)(endTime).minus(startTime);
    const isAscending = endAmountBn.gt(startAmount);
    const adjustedBlockTimestamp = (0, utils_2.toBn)(isAscending ? currentBlockTimestamp + ascendingAmountTimestampBuffer : currentBlockTimestamp);
    if (adjustedBlockTimestamp.lt(startTime)) {
        return startAmountBn;
    }
    const elapsed = (adjustedBlockTimestamp.gt(endTime) ? (0, utils_2.toBn)(endTime) : adjustedBlockTimestamp).minus(startTime);
...
const getSummedTokenAndIdentifierAmounts = ({ items, criterias, timeBasedItemParams, }) => {
    ...
    const tokenAndIdentifierToSummedAmount = items.reduce((map, item) => {
        ...
        return Object.assign(Object.assign({}, map), { [item.token]: Object.assign(Object.assign({}, map[item.token]), { 
                ...
                [identifierOrCriteria]: (0, utils_2.toBn)((_d = (_c = map[item.token]) === null || _c === void 0 ? void 0 : _c[identifierOrCriteria]) !== null && _d !== void 0 ? _d : (0, utils_2.toBn)(0)).plus((0, exports.getPresentItemAmount)({
    ...
    Object.keys(tokenAndIdentifierToSummedAmount).forEach(itemToken => {
        Object.keys(tokenAndIdentifierToSummedAmount[itemToken]).forEach(id => {
            var _a;
            tokenAndIdentifierToSummedAmount[itemToken][id] = (_a = tokenAndIdentifierToSummedAmount[itemToken][id]) === null || _a === void 0 ? void 0 : _a.integerValue(utils_1.BigNumber.ROUND_CEIL);
        });
    });
