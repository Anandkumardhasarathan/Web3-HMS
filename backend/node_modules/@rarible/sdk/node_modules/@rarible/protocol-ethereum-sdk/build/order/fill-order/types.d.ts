...
import type { SimpleCryptoPunkOrder, SimpleLegacyOrder, SimpleLooksrareOrder, SimpleOpenSeaV1Order, SimpleRaribleV2Order, SimpleSeaportV1Order, SimpleX2Y2Order, SimpleAmmOrder, SimpleLooksrareV2Order } from "../types";
import type { NftAssetType } from "../check-asset-type";
export type CommonFillRequestAssetType = Erc721AssetType | Erc721LazyAssetType | Erc1155AssetType | Erc1155LazyAssetType | CryptoPunksAssetType | NftAssetType;
...
export type OrderV2FillDataV2 = {
    payouts?: Part[];
    originFees?: Part[];
};
export type OrderV2FillDataV3 = {
    payouts?: Part[];
    originFees?: Part[];
};
...
export type SeaportV1OrderFillRequest = CommonFillRequest<SimpleSeaportV1Order> & {
    originFees?: Part[];
};
export type X2Y2OrderFillRequest = CommonFillRequest<SimpleX2Y2Order> & {
    originFees?: Part[];
};
...
export type SellOrderRequest = LegacyOrderFillRequest | RaribleV2OrderFillRequestV2 | RaribleV2OrderFillRequestV3 | OpenSeaV1OrderFillRequest | SeaportV1OrderFillRequest | CryptoPunksOrderFillRequest | LooksrareOrderFillRequest | LooksrareOrderV2FillRequest | X2Y2OrderFillRequest | AmmOrderFillRequest;
export type BuyOrderRequest = LegacyOrderFillRequest | RaribleV2OrderFillRequestV2 | RaribleV2OrderFillRequestV3 | OpenSeaV1OrderFillRequest | SeaportV1OrderFillRequest | CryptoPunksOrderFillRequest | LooksrareOrderFillRequest | LooksrareOrderV2FillRequest | X2Y2OrderFillRequest | AmmOrderFillRequest;
export type FillOrderRequest = SellOrderRequest | BuyOrderRequest;
export type FillBatchSingleOrderRequest = RaribleV2OrderFillRequestV2 | OpenSeaV1OrderFillRequest | LooksrareOrderFillRequest | LooksrareOrderV2FillRequest | SeaportV1OrderFillRequest | X2Y2OrderFillRequest | AmmOrderFillRequest;
export type FillBatchOrderRequest = FillBatchSingleOrderRequest[];
export declare enum ExchangeWrapperOrderType {
    RARIBLE_V2 = 0,
    OPENSEA_V1 = 1,
...
export type GetOrderBuyBatchTxData = (request: FillBatchSingleOrderRequest[], originFees: Part[] | undefined) => Promise<OrderFillTransactionData>;
