...
exports.getSolanaMockWallet = exports.solanaWalletMocks = exports.solanaTestWords = exports.solanaKeyKinds = void 0;
exports.solanaKeyKinds = ["privateKey", "arrayPrivateKey"];
exports.solanaTestWords = ["test"];
const wallet0 = {
...
exports.solanaWalletMocks = {
    0: wallet0,
};
function getSolanaMockWallet(index) {
    return exports.solanaWalletMocks[index];
}
exports.getSolanaMockWallet = getSolanaMockWallet;
