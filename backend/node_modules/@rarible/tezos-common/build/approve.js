...
exports.approve = exports.approve_v2 = exports.approve_arg = exports.approve_fa2 = exports.approve_fa2_arg = exports.approve_fa1_2 = exports.approve_fa1_2_arg = exports.get_big_map_value = void 0;
...
function approve_fa1_2_arg(provider, owner, contract, value, spender) {
    return __awaiter(this, void 0, void 0, function () {
        var st, key_exists, allowance, r, error_1, parameter;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    spender = spender || provider.config.transfer_proxy;
                    return [4 /*yield*/, (0, base_1.get_storage)(provider, contract)];
                case 1:
                    st = _a.sent();
                    key_exists = false;
                    allowance = 0;
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, st.allowance.get({
                            0: owner,
                            1: spender
                        })];
                case 3:
                ...
                case 5:
                    if (!key_exists || allowance == 0) {
                        parameter = { prim: 'Pair', args: [{ string: spender }, { int: value.toString() }] };
...
function approve_fa1_2(provider, owner, contract, value) {
    return __awaiter(this, void 0, void 0, function () {
        var arg;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, approve_fa1_2_arg(provider, owner, contract, value)];
                case 1:
                    arg = _a.sent();
                    if (arg) {
                        try {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    st = _c.sent();
                    key_exists = false;
                    if (!(use_all && st.operators_for_all)) return [3 /*break*/, 6];
                    _c.label = 2;
                case 2:
                    _c.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, st.operators_for_all.get({ 0: operator, 1: owner })];
                case 3:
                    r = _c.sent();
                    key_exists = (r != undefined);
                    return [3 /*break*/, 5];
...
function approve_arg(provider, owner, asset, real_amount, use_all, operator) {
    if (use_all === void 0) { use_all = false; }
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            if (asset.asset_type.asset_class == "FT" && asset.asset_type.token_id == undefined) {
                return [2 /*return*/, approve_fa1_2_arg(provider, owner, asset.asset_type.contract, real_amount, operator)];
            }
...
function approve_v2(provider, owner, asset_type, operator, asset_contract, asset_token_id, amount, use_all) {
    if (use_all === void 0) { use_all = false; }
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            if (asset_type == base_1.AssetTypeV2.FA12) {
                return [2 /*return*/, approve_fa1_2_arg(provider, owner, asset_contract, amount, operator)];
            }
            else if (asset_type == base_1.AssetTypeV2.FA2) {
                return [2 /*return*/, approve_fa2_arg(provider, owner, asset_contract, asset_token_id, use_all, operator)];
            }
            return [2 /*return*/];
        });
    });
}
exports.approve_v2 = approve_v2;
function approve(provider, owner, asset, real_amount, use_all) {
    if (use_all === void 0) { use_all = false; }
    return __awaiter(this, void 0, void 0, function () {
        var arg;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, approve_arg(provider, owner, asset, real_amount, use_all)];
                case 1:
                    arg = _a.sent();
                    if (arg) {
                        return [2 /*return*/, (0, base_1.send)(provider, arg)];
