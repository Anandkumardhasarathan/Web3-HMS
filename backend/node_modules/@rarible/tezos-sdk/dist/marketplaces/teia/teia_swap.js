...
exports.teia_swap = exports.teia_swap_arg = void 0;
var tezos_common_1 = require("@rarible/tezos-common");
var bignumber_js_1 = require("bignumber.js");
var tezos_common_2 = require("@rarible/tezos-common");
function teia_swap_arg(provider, swap, creator, royalties) {
    var parameter = {
        prim: "Pair",
        args: [
            {
                string: "".concat(provider.config.hen_objkts)
            },
            {
                prim: "Pair",
                args: [
    ...
    return { destination: provider.config.teia_marketplace, entrypoint: "swap", parameter: parameter };
}
exports.teia_swap_arg = teia_swap_arg;
function teia_swap(provider, order) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    seller = _a.sent();
                    return [4 /*yield*/, (0, tezos_common_1.approve_v2)(provider, seller, tezos_common_1.AssetTypeV2.FA2, provider.config.teia_marketplace, provider.config.hen_objkts, order.token_id)];
                case 2:
                    approve_a = _a.sent();
                    if (approve_a)
                ...
                case 3:
                    royalties = _a.sent();
                    args = args.concat(teia_swap_arg(provider, order, royalties[0].account, new bignumber_js_1.default(royalties[0].value).div(10)));
                    if (args.length === 0) {
