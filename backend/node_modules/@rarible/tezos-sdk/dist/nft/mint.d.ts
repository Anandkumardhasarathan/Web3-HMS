import { Provider, TransactionArg, OperationResult, MintResult, BatchMintResult } from "@rarible/tezos-common";
...
export declare function mint_batch(provider: Provider, form: Array<MintingForm>): Promise<BatchMintResult>;
