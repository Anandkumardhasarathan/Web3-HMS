...
exports.mint_batch = exports.mint = exports.mint_arg = exports.mint_mt = exports.mint_mt_arg = exports.mint_nft = exports.mint_nft_arg = exports.set_token_metadata = exports.metadata_arg = exports.get_next_token_id = void 0;
var tezos_common_1 = require("@rarible/tezos-common");
var bignumber_js_1 = require("bignumber.js");
var fetch_wrapper_1 = require("@rarible/tezos-common/build/fetch-wrapper");
...
function get_next_token_id(provider, contract) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, fetch_wrapper_1.fetchAPI)('/collections/TEZOS:' + contract + '/generate_token_id', {
...
exports.mint = mint;
function mint_batch(provider, form) {
    return __awaiter(this, void 0, void 0, function () {
        var args, ids, form_1, form_1_1, mint_1, _a, next_id, arg, _b, next_id, arg, e_1_1, op;
        var e_1, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    _d.label = 2;
                case 2:
                    if (!!form_1_1.done) return [3 /*break*/, 7];
                    mint_1 = form_1_1.value;
                    if (!(mint_1.supply != undefined)) return [3 /*break*/, 4];
                    return [4 /*yield*/, mint_mt_arg(provider, mint_1.contract, mint_1.royalties, mint_1.supply, mint_1.token_id, mint_1.metadata, mint_1.owner)];
                case 3:
                    _a = __read.apply(void 0, [_d.sent(), 2]), next_id = _a[0], arg = _a[1];
                    args = args.concat(arg);
                    ids.push(next_id);
                    return [3 /*break*/, 6];
                case 4: return [4 /*yield*/, mint_nft_arg(provider, mint_1.contract, mint_1.royalties, mint_1.token_id, mint_1.metadata, mint_1.owner)];
                case 5:
                    _b = __read.apply(void 0, [_d.sent(), 2]), next_id = _b[0], arg = _b[1];
                    args = args.concat(arg);
                    ids.push(next_id);
                    _d.label = 6;
                case 6:
                ...
                case 9:
                    try {
                        if (form_1_1 && !form_1_1.done && (_c = form_1.return)) _c.call(form_1);
                    }
                    finally { if (e_1) throw e_1.error; }
                    return [7 /*endfinally*/];
                case 10: return [4 /*yield*/, (0, tezos_common_1.send_batch)(provider, args)];
                case 11:
                    op = _d.sent();
                    return [2 /*return*/, __assign(__assign({}, op), { token_ids: ids })];
            }
        });
    });
}
exports.mint_batch = mint_batch;
