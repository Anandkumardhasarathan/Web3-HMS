...
var tezos_common_3 = require("@rarible/tezos-common");
...
function get_counter(provider, contract, mandator) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, (0, tezos_common_2.get_storage)(provider, contract)];
                case 1:
                    st = _b.sent();
                    permits = st.permits;
...
function make_permit(provider, contract, transfers, counter) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, (0, tezos_common_2.get_address)(provider)];
                case 1:
                    issuer = _b.sent();
                    return [4 /*yield*/, (0, tezos_common_3.get_public_key)(provider)];
                case 2:
                    pk = _b.sent();
                    if (pk == undefined)
                ...
                case 6:
                    ...
                    return [4 /*yield*/, (0, tezos_common_2.get_sign)(provider, permit)];
                case 7:
