...
function fill_offchain_royalties(provider, order) {
    return __awaiter(this, void 0, void 0, function () {
        var asset, contract, royalties, is_on_chain, data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    contract = (asset.contract) ? asset.contract
                        : (asset.asset_class == "NFT") ? provider.config.nft_public
                            : provider.config.mt_public;
                    return [4 /*yield*/, (0, tezos_common_1.get_royalties)(provider, contract, new bignumber_js_1.default(asset.token_id))];
                case 1:
                    royalties = _a.sent();
                    return [4 /*yield*/, (0, tezos_common_1.are_royalties_on_chain)(provider, contract, new bignumber_js_1.default(asset.token_id))];
                case 2:
                    is_on_chain = _a.sent();
