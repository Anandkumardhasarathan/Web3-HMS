...
exports.Web3EthContractTypes = exports.Web3Types = exports.FMT_NUMBER = exports.FMT_BYTES = exports.Web3 = exports.getCurrentProviderId = exports.Web3Transaction = exports.Web3FunctionCall = exports.Web3Contract = exports.Web3v4Ethereum = void 0;
...
Object.defineProperty(exports, "FMT_BYTES", { enumerable: true, get: function () { return web3_types_1.FMT_BYTES; } });
Object.defineProperty(exports, "FMT_NUMBER", { enumerable: true, get: function () { return web3_types_1.FMT_NUMBER; } });
...
class Web3v4Ethereum {
    constructor(config) {
        this.config = config;
        if (!Web3v4Ethereum.isWeb3v4(config.web3)) {
            throw new Error(`Passed version web3=${(0, sdk_common_1.getWeb3Version)(config.web3)}, expected v4`);
        }
        this.send = this.send.bind(this);
        this.getFrom = this.getFrom.bind(this);
    }
    static isWeb3v4(web3Instance) {
        return (0, sdk_common_1.isWeb3v4)(web3Instance);
    }
    createContract(abi, address) {
        return new Web3Contract(this.config, new this.config.web3.eth.Contract(abi, address, domain_1.NumberDataFormat));
    }
    send(method, params) {
    ...
    personalSign(message) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const signature = yield this.config.web3.eth.personal.sign(message, signer.toLowerCase(), "");
    ...
    sendTransaction(options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const promiEvent = this.config.web3.eth.sendTransaction(transactionOptions, domain_1.NumberDataFormat);
                const promises = (0, to_promises_1.toPromises)(promiEvent);
                return new Web3Transaction(promises.receipt, (0, types_1.toWord)(yield promises.hash), (0, types_1.toBinary)(enrichedData), (0, types_1.toEVMAddress)(from));
            }
            catch (error) {
    ...
    decodeParameter(type, data) {
        try {
            ...
            return (0, sdk_common_1.deepReplaceBigInt)(decodedData);
        }
        catch (error) {
    ...
    getBalance(address) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const amount = yield (0, sdk_common_1.conditionalRetry)(5, 3000, () => tslib_1.__awaiter(this, void 0, void 0, function* () {
                    return (0, types_1.toBigNumber)(yield this.config.web3.eth.getBalance(address, this.config.web3.eth.defaultBlock, {
                        number: web3_types_1.FMT_NUMBER.STR,
                        bytes: web3_types_1.FMT_BYTES.HEX,
                    }));
                }), error => (error === null || error === void 0 ? void 0 : error.message) === sdk_common_1.FAILED_TO_FETCH_ERROR);
    ...
    getChainId() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                return +(yield this.config.web3.eth.getChainId(domain_1.NumberDataFormat));
            }
            catch (error) {
...
exports.Web3v4Ethereum = Web3v4Ethereum;
class Web3Contract {
...
class Web3FunctionCall {
    ...
    getReserveNode() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return (this.config.reserveNodes && this.config.reserveNodes[+(yield this.config.web3.eth.getChainId(domain_1.NumberDataFormat))]);
        });
    }
    estimateGas() {
        return tslib_1.__awaiter(this, arguments, void 0, function* (options = {}) {
            try {
                return yield (0, sdk_common_1.conditionalRetry)(5, 3000, () => this.sendMethod.estimateGas(Object.assign(Object.assign({}, options), { value: typeof (options === null || options === void 0 ? void 0 : options.value) === "number" ? options === null || options === void 0 ? void 0 : options.value.toFixed() : options === null || options === void 0 ? void 0 : options.value }), domain_1.NumberDataFormat), error => (error === null || error === void 0 ? void 0 : error.message) === sdk_common_1.FAILED_TO_FETCH_ERROR);
            }
            catch (error) {
                ...
                try {
                    ...
                    [callInfo, chainId, data] = yield (0, sdk_common_1.promiseSettledRequest)([
                        this.getCallInfo(),
                        this.config.web3.eth.getChainId(domain_1.NumberDataFormat),
                        yield this.getData(),
                    ]);
                }
                catch (_) { }
    ...
    callWithRetry(sendMethod_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function* (sendMethod, options = {}) {
            const gasOptions = getGasOptions(this.config, options);
            return yield (0, sdk_common_1.conditionalRetry)(5, 3000, () => tslib_1.__awaiter(this, void 0, void 0, function* () {
                const result = yield sendMethod.call(Object.assign(Object.assign({ from: this.config.from }, gasOptions), { gas: typeof gasOptions.gas === "number" ? gasOptions.gas.toFixed() : gasOptions.gas }));
                return (0, sdk_common_1.deepReplaceBigInt)(result);
            }), error => (error === null || error === void 0 ? void 0 : error.message) === sdk_common_1.FAILED_TO_FETCH_ERROR);
        });
    }
    call() {
    ...
    _send() {
        return tslib_1.__awaiter(this, arguments, void 0, function* (options = {}, gasOptions = getGasOptions(this.config, options)) {
            const [callInfo, chainId] = yield Promise.all([
                this.getCallInfo(),
                this.config.web3.eth.getChainId(domain_1.NumberDataFormat),
            ]);
            let hash;
            ...
            try {
                ...
                const additionalData = typeof options.additionalData !== "undefined" ? (0, types_1.toBinary)(options.additionalData).slice(2) : "";
                ...
                throw new ethereum_provider_1.EthereumProviderError(Object.assign(Object.assign({}, getProvidersData(this.config)), { method: "Web3FunctionCall.send", error,
...
class Web3Transaction {
    ...
    wait() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const receipt = yield this.receipt;
                return Object.assign(Object.assign({}, receipt), { status: !!receipt.status });
            }
            catch (error) {
    ...
    getEvents() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const receipt = yield this.receipt;
            if (receipt.events) {
                return Object.values(receipt.events || {}).map(e => (Object.assign(Object.assign({}, e), { logIndex: Number(e.logIndex) || 0, transactionIndex: Number(e.transactionIndex) || 0, transactionHash: e.transactionHash || "", blockHash: e.blockHash || "", args: e.returnValues })));
            }
...
function getCommonErrorData(config) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const [signer, chainId, blockNumber] = yield (0, sdk_common_1.promiseSettledRequest)([
            ...
            config.web3.eth.getChainId(domain_1.NumberDataFormat),
            config.web3.eth.getBlockNumber(domain_1.NumberDataFormat),
        ]);
...
Object.defineProperty(exports, "Web3Types", { enumerable: true, get: function () { return web3_2.types; } });
exports.Web3EthContractTypes = tslib_1.__importStar(require("web3-eth-contract"));
